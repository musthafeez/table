...
import com.example.minilogin.util.DButil1;
...
public class ProductInfoDaoImpl implements ProductInfoDao{
	...
	public ProductInfoDaoImpl() {
		...
		connection1 = DButil1.getConnection();
		connection2 = DButil1.getConnection();
		connection3= DButil1.getConnection();
		connection4= DButil1.getConnection();
	...
	try {
		...
		PreparedStatement stmt0 = connection1.prepareStatement("select * from product_info where category_type=0");
...
return list2;
	...
	public List<ProductInfo> viewAllProducts1( ){
		...
		try {
			...
			PreparedStatement stmt1 = connection2.prepareStatement("select * from product_info where category_type=1");
	...
	public List<ProductInfo> viewAllProducts2( ){
		...
		try {
			...
			PreparedStatement stmt2 = connection3.prepareStatement("select * from product_info where category_type=2");
	...
	public List<ProductInfo> viewAllProducts3(){
		...
		try {
			...
			PreparedStatement stmt3 = connection4.prepareStatement("select * from product_info where category_type=3");
